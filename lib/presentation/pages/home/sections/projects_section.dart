...
class _ProjectsSectionState extends State<ProjectsSection>
            ...
            return Container(
              ...
              child: ContentArea(
                ...
                child: Column(
                  ...
                  children: [
                    _buildCustomInfoSectionSm(),
                    const SpaceH40(),
                    CustomButton(
                      buttonTitle: AppConst.ALL_PROJECTS,
                      ...
                      child: Row(
                        ...
                        children: [
                          ContentArea(
                            ...
                            child: _buildCustomInfoSectionLg(),
                          ),
                          const Spacer(),
                          CustomButton(
                            buttonTitle: AppConst.ALL_PROJECTS,
  ...
  Widget _buildCustomInfoSectionSm() {
    return const CustomInfoSection2(
      sectionTitle: AppConst.MY_WORKS,
      title1: AppConst.MEET_MY_PROJECTS,
      hasTitle2: false,
      body: AppConst.PROJECTS_DESC,
//      child: ,
    );
  }

  Widget _buildCustomInfoSectionLg() {
